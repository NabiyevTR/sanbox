...
public class CustomImageDeskew  {
    ...
    public double getSkewAngle() {
        CustomImageDeskew.HoughLine[] hl;
        double sum = 0.0;
        int count = 0;
    ...
    private CustomImageDeskew.HoughLine[] getTop(int count) {

        CustomImageDeskew.HoughLine[] hl = new CustomImageDeskew.HoughLine[count];
        for (int i = 0; i < count; i++) {
            hl[i] = new CustomImageDeskew.HoughLine();
        }

        CustomImageDeskew.HoughLine tmp;
